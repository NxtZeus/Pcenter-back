    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metodo_pago', models.CharField(choices=[('efectivo', 'Efectivo'), ('tarjeta_credito', 'Tarjeta de Crédito'), ('tarjeta_debito', 'Tarjeta de Débito')], max_length=50)),
                ('precio_total', models.DecimalField(decimal_places=2, max_digits=10)),
                ('estado_pedido', models.CharField(choices=[('pendiente', 'Pendiente'), ('procesando', 'Procesando'), ('enviado', 'Enviado'), ('entregado', 'Entregado'), ('cancelado', 'Cancelado')], max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Producto',
            fields=[
                ...
                ('categoria', models.CharField(choices=[('ordenadores', 'Ordenadores'), ('mobiles', 'Mobiles'), ('perifericos', 'Perifericos'), ('componentes', 'Componentes'), ('accesorios', 'Accesorios'), ('software', 'Software')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio_reembolso', models.DecimalField(decimal_places=2, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.producto')),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.usuario')),
            ],
        ),
        migrations.AddField(
            model_name='pedido',
